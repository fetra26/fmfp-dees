...
return [
    ...
    */
    ...
    'payload' => [
        'max_size' => 16 * 1024 * 1024,   // 16MB - suffisant pour l'assistant d'import (grandes listes de valeurs inconnues)
        'max_nesting_depth' => 20,        // Résolutions peuvent avoir plus de niveaux imbriqués
        'max_calls' => 200,               // Wizard multi-étapes
        'max_components' => 300,          // Pages avec plusieurs widgets
    ],
];
